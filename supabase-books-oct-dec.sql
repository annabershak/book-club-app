...
-- Вместимость 12 мест, цена 5 € — поменяй ниже, если нужно другое.
...
-- Если ты уже запускала этот скрипт раньше (когда вместимость была 10),
-- выполни отдельно ещё и это, чтобы обновить уже добавленные книги:
--
-- update books set capacity = 12
-- where event_date in ('2026-10-03', '2026-10-24', '2026-11-14', '2026-12-05');
